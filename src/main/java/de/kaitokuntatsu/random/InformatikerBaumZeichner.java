...
public class InformatikerBaumZeichner extends Frame {

    BinaryTree<Informatiker> _baum;
    BufferedImage img;
    Graphics g;
    int _dy;              //  Abstand der Baumebenen
    int _tiefe = 0;       //  Tiefe des Baumes

    public InformatikerBaumZeichner(int frameWidth, int frameHeight, BinaryTree<Informatiker> pBaum) {
        super("Baumzeichner");
        _baum = pBaum;
    ...
    public InformatikerBaumZeichner(BinaryTree<Informatiker> pBaum)
    {
        new InformatikerBaumZeichner(800, 600, pBaum);
    }
    ...
    private void zeichneInorder(int links, int rechts, int y, BinaryTree<Informatiker> baum)
    ...
    private void tief(BinaryTree<Informatiker> baum, int t)
    {   if (baum.isEmpty()) return;
    ...
    public int tiefe(BinaryTree<Informatiker> baum)
    {  _tiefe = 0;
        tief(baum, 1);
        return _tiefe ;
    }
